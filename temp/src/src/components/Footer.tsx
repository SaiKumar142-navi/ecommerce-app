        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Your premium destination for the latest tech, furniture, and lifestyle products. 
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground">support@eliteshop.com</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground">123 Commerce St, City, ST 12345</span>
              </div>
            </div>
          </div>
        </div>
